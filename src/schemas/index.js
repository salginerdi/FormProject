...
export const basicSchema = yup.object().shape({
  ...
  password: yup
    ...
    confirmPassword: yup.string().oneOf([yup.ref('password')], 'Şifreler eşleşmemektedir').required('Tekrar şifre girmek zorunludur'),
});
...
export const advancedSchema = yup.object().shape({
    ...
    university: yup
      .string()
      .oneOf(['bogazici','gsu','odtü','itü'],'Lütfen üniversitenizi seçiniz').required('Lütfen üniversitenizi seçiniz'),
    isAccepted: yup
      .boolean() .oneOf([true],'Lütfen Kullanım koşullarını kabul ediniz')
  });